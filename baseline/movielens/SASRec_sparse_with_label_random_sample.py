...
def parse_args():
    ...
    parser.add_argument("--multi_head", type=int, default=4, help = "multi head for SASRec")
...
if __name__ == '__main__':
    result_list_valid = []
    result_list_test = []
    for sample_num in [512]: #[1,2,4,8,16,32,64,128,256,512]: #[2,4,8,16,32,64,128,256,512]:
        args = parse_args()
