...
do
    ...
    do
        ...
        do
                mkdir -p /data/baokq/alpaca-lora/instruct_shuffle_sparse_7B_v3_${lr}_${dropout}_${seed}_${sample}
                ...
                CUDA_VISIBLE_DEVICES=$1 python -u finetune_rec.py \
                    ...
                    --train_data_path '/data/baokq/ml-100k/sequential_sparse_v1/train_v9.json' \
                    --val_data_path '/data/baokq/ml-100k/sequential_sparse_v1/valid_v3.json' \
                    --output_dir /data/baokq/alpaca-lora/instruct_shuffle_sparse_7B_v3_${lr}_${dropout}_${seed}_${sample} \
                    --batch_size 128 \
