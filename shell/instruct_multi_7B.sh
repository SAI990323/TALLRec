...
do
    ...
    do
        ...
        do
                mkdir -p /data/baokq/alpaca-lora/instruct_multi_7B_${lr}_${dropout}_${seed}_${sample}
                echo "lr: $lr, dropout: $dropout , seed: $seed, sample: $sample"
                CUDA_VISIBLE_DEVICES=$1 python -u finetune_multi_rec.py \
                    ...
                    --train_data_path2 '/data/baokq/books/train.json' \
                    --val_data_path '/data/baokq/ml-100k/sequential_sparse_v1/valid_v3.json' \
                    --val_data_path2 '/data/baokq/books/valid.json' \
                    --output_dir /data/baokq/alpaca-lora/instruct_multi_7B_${lr}_${dropout}_${seed}_${sample} \
                    --batch_size 128 \
                    --micro_batch_size 64 \
                    --num_epochs 200 \
                    --learning_rate $lr \
