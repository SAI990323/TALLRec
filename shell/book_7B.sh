...
do
    for dropout in 0.05
    do
        for sample in 64 128 256 512
        do
                mkdir -p /data/baokq/alpaca-lora/book_7B_${lr}_${dropout}_${seed}_${sample}
                ...
                CUDA_VISIBLE_DEVICES=$1 python -u finetune_rec.py \
                    ...
                    --output_dir /data/baokq/alpaca-lora/book_7B_${lr}_${dropout}_${seed}_${sample} \
                    --batch_size 128 \
                    --micro_batch_size 64 \
                    --num_epochs 200 \
                    --learning_rate $lr \
