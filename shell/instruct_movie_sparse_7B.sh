...
do
    ...
    do
        ...
        do
                mkdir -p /data/baokq/alpaca-lora/insturct_sparse_7B_${lr}_${dropout}_${seed}_${sample}
                ...
                CUDA_VISIBLE_DEVICES=$1 python -u finetune_rec.py \
                    ...
                    --output_dir /data/baokq/alpaca-lora/instruct_sparse_7B_${lr}_${dropout}_${seed}_${sample} \
                    --batch_size 128 \
